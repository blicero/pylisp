...
# Time-stamp: <2025-09-11 18:58:39 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-09-11 Do 18:58]
   | Headline                  | Time    |         |       |      |      |
   |---------------------------+---------+---------+-------+------+------|
   | *Total time*              | *18:54* |         |       |      |      |
   |---------------------------+---------+---------+-------+------+------|
...
*** Testing [0/0]
    ...
    :VISIBILITY: children
    :END:
    One advantage of this type of program is that it is easy to run tons and
    tons of tests automatically. But you need to write them. And by "you", I
    mean "me", of course.
**** Data types [0/0]
     :PROPERTIES:
     :COOKIE_DATA: todo recursive
     ...
     :END:
     :LOGBOOK:
     CLOCK: [2025-09-11 Do 17:44]--[2025-09-11 Do 18:31] =>  0:47
     :END:
**** Parser [0/0]
     :PROPERTIES:
     :COOKIE_DATA: todo recursive
     ...
     :END:
     :LOGBOOK:
     CLOCK: [2025-09-11 Do 18:31]--[2025-09-11 Do 18:58] =>  0:27
     :END:
**** Interpreter [0/0]
     :PROPERTIES:
     :COOKIE_DATA: todo recursive
